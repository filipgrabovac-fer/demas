import type { ParsedData, JsonValue, JsonObject, JsonArray } from "./data-upload-form.types"
...
function normalizeJsonValue(value: JsonValue): string | number | boolean | null {
...
function preserveJsonStructure(obj: JsonObject): Record<string, string | number | boolean | null> {
...
export async function parseJSON(file: File): Promise<ParsedData> {
  ...
  throw new Error("JSON file must contain an object, array, or primitive value")
}
